...
export default function MessageInput({ onSendMessage, isLoading, onFileUpload, uploadedFile, isUploading, onRemoveFile }) {
        ...
        <div style={{ maxWidth: 720, margin: '0 auto 8px', paddingLeft: 4 }}>
          <div style={{
            ...
            <span style={{fontSize: 13}}>
              ...
              : uploadedFile.name?.match?.(/\.(jpg|jpeg|png)/)
                ? '🖼️' : '📎'}
            </span>
            ...
            {/* File size */}
            {uploadedFile.size > 0 && (
              <span style={{ fontSize: 10, color: '#7A839E' }}>
                ({(uploadedFile.size / 1024).toFixed(0)}KB)
              </span>
            )}

            {/* Checkmark */}
            <span style={{ fontSize: 11, color: '#00E5C3', fontWeight: 700 }}>✓</span>
            ...
            <button
              ...
              onMouseLeave={e => {
                ...
                e.currentTarget.style.color = '#7A839E'
              }}
            >
              ✕
            </button>
